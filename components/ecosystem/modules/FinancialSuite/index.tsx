...
export default function FinancialSuite() {
  ...
  const features = [
    {
      ...
      description: '95% accurate 6-month forecasting with monsoon impact modeling'
    },
    {
      icon: Smartphone,
      title: 'Bangladesh Banking',
      description: 'bKash, Nagad, BRAC Bank & Dutch-Bangla Bank integration'
    },
    {
      icon: FileText,
      title: 'Smart Invoice Processing',
      description: 'OCR + NLP for automated NBR tax compliance'
    },
    {
      icon: Shield,
      title: 'Financial Security',
      description: 'Real-time anomaly detection & fraud prevention'
    }
  ]
  ...
  const metrics = [
    { 
      ...
      value: formatBDT(realtimeMetrics.monthlyRevenue), 
      trend: `+${realtimeMetrics.profitMargin.toFixed(1)}%` 
    },
    { 
      label: 'Net Profit', 
      value: formatBDT(realtimeMetrics.netProfit), 
      trend: 'Strong Growth' 
    },
    { 
      label: 'Profit Margin', 
      value: `${realtimeMetrics.profitMargin.toFixed(1)}%`, 
      trend: '+2.3% vs target' 
    },
    { 
      label: 'Cash Position', 
      value: formatBDT(financialData.cashFlow.currentBalance), 
      trend: 'Healthy' 
    }
  ]
  ...
  return (
    <ModuleWrapper
      moduleName="Financial Intelligence Suite"
      moduleIcon={DollarSign}
      moduleDescription="AI-powered financial control with real-time insights, predictive analytics, and Bangladesh banking integration"
      features={features}
      metrics={metrics}
      accentColor="#10B981"
      directAccess={true}
