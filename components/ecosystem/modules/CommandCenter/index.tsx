...
export default function CommandCenter() {
  ...
  // Simulated metrics for module wrapper
  const features = [
    {
      icon: Brain,
      title: 'AI-Powered Intelligence',
      description: 'Real-time construction insights with 95% accuracy'
    },
    {
      icon: MapPin,
      title: 'Multi-Site Control',
      description: 'Manage 50+ construction sites from one dashboard'
    },
    {
      icon: Activity,
      title: 'Real-Time Monitoring',
      description: 'Live data streaming from IoT sensors & drones'
    },
    {
      icon: Shield,
      title: 'Predictive Safety',
      description: 'AI-powered incident prevention & compliance'
    }
  ]

  const metrics = [
    { label: 'Active Sites', value: '47', trend: '+12% this month' },
    { label: 'AI Predictions', value: '2,847', trend: '95% accuracy' },
    { label: 'Safety Score', value: '98.5%', trend: 'Industry leading' },
    { label: 'Efficiency Gain', value: '+34%', trend: 'vs traditional' }
  ]
  ...
  return (
    <ModuleWrapper
      ...
      moduleIcon={Command}
      moduleDescription="Enterprise-grade construction command center with AI-powered intelligence, real-time monitoring, and predictive analytics"
      features={features}
      metrics={metrics}
      accentColor="#00D9FF"
      directAccess={true}
      ...
      <div className="h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            <motion.div
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 backdrop-blur-md border border-white/10"
              whileHover={{ scale: 1.05 }}
            >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <motion.div
            className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-cyan-500/2 via-blue-500/2 to-transparent rounded-full blur-3xl"
            animate={{
              x: [0, 20, 0],
              y: [0, -10, 0],
          ...
          />
          <motion.div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-purple-500/2 via-pink-500/2 to-transparent rounded-full blur-3xl"
            animate={{
              x: [0, -15, 0],
              y: [0, 15, 0],
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs text-white/60">Active Predictions</div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs text-white/60">Workers Online</div>
              </div>
            </div>
          </motion.div>
        </motion.div>
