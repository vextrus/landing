...
export default function HRWorkforceDashboard() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      {/* Enhanced Floating Workforce Metrics */}
      <motion.div
        ...
        >
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs glass-text-muted">Total</div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs glass-text-muted">Present</div>
            </div>
            <div className="w-px h-8 bg-white/20" />
            <div className="flex flex-col items-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-cyan-500/10 via-teal-500/5 to-transparent rounded-full blur-3xl"
          animate={{
            x: [0, -15, 0],
            y: [0, 15, 0],
            opacity: [0.2, 0.5, 0.2]
