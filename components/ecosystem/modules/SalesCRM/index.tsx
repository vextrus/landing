...
export default function SalesCRM() {
  ...
  const features = [
    {
      ...
      description: 'ML-powered qualification with 92% accuracy'
    },
    {
      icon: Building2,
      title: '3D Property Visualization',
      description: 'Interactive building models with real-time rendering'
    },
    {
      icon: MessageSquare,
      title: 'WhatsApp CRM Integration',
      description: 'Business API with Bengali voice notes and automation'
    },
    {
      icon: Camera,
      title: 'AR Property Tours',
      description: 'Mobile AR walkthrough experience with 360° views'
    }
  ]
  ...
  const metrics = [
    ...
    { label: 'Avg Deal Size', value: '৳8.5 Cr', trend: '+12%' },
    { label: 'Sales Cycle', value: '45 days', trend: '-20%' }
  ]

  return (
    <ModuleWrapper
      moduleName="AI Sales & Lead Management"
      moduleIcon={Users}
      moduleDescription="NLP-powered lead management with 3D visualization, AR property tours, and WhatsApp CRM integration"
      features={features}
      metrics={metrics}
      accentColor="#8B5CF6"
      directAccess={true}
