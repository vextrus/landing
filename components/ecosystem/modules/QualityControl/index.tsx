...
export default function QualityControl() {
  ...
  const features = [
    {
      ...
      description: 'Computer vision with 98% accuracy'
    },
    {
      icon: Activity,
      title: 'Real-time Monitoring',
      description: 'Live quality metrics dashboard'
    },
    {
      icon: FileCheck,
      title: 'Auto Inspection',
      description: 'Photo-based quality verification'
    },
    {
      icon: Wrench,
  ...
  const metrics = [
    { label: 'Defects Detected', value: '2,341', trend: '-35%' },
    { label: 'Quality Score', value: '96.8%', trend: '+2.3%' },
    { label: 'Inspections/Day', value: '487', trend: '+18%' },
    { label: 'Downtime Prevented', value: '124h', trend: '+42%' }
  ]

  return (
    <ModuleWrapper
      moduleName="AI Quality Control Suite"
      moduleIcon={Shield}
      moduleDescription="Computer vision-powered quality assurance with predictive maintenance"
      features={features}
      metrics={metrics}
      accentColor="#F59E0B"
      directAccess={true}
